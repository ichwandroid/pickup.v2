...
<div class="col-lg-9 mx-auto p-3 py-md-5">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
      ...
      <span class="fs-4">Track Pickup Dashboard</span>
    </a>
  </header>
  ...
  <main>
    <table class="table table-striped table-hover">
      ...
      <tbody>
        <?php $crud->dataviewguru("SELECT * FROM tbl_siswa JOIN tbl_scan ON tbl_scan.NIS = tbl_siswa.NIS WHERE KELAS='1 A - ZAINAB R.A' ORDER BY TANGGAL DESC");?>
      </tbody>
    </table>
