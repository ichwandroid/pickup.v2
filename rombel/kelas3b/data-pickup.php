...
<html lang="en">
  ...
  <main>
    <table class="table table-striped table-hover">
      ...
      <tbody>
        <?php $crud->dataviewguru("SELECT * FROM tbl_siswa JOIN tbl_scan ON tbl_scan.NIS = tbl_siswa.NIS WHERE KELAS='3 B - ASMA\' BINTI ABU BAKAR R.A' ORDER BY TIMESCAN DESC");?>
      </tbody>
    </table>
